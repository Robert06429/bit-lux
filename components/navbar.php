    ...
    <div class="relative flex justify-between items-center px-8 py-6 pb-3 max-w-full overflow-x-clip">
        ...
        <div class="flex items-center gap-6 z-10">
            ...
            <button class="nav-icon text-white transition-colors duration-400 hover:opacity-70 cursor-pointer relative" aria-label="Shopping Bag" id="cartBtn">
                ...
                <span class="bag-badge absolute -top-1.5 -right-1.5 bg-[#1a1a1a] text-white rounded-full w-3.5 h-3.5 flex items-center justify-center text-[0.6rem] font-semibold">0</span>
            </button>
        </div>
    </div>
...
<div class="search-overlay fixed top-0 left-0 w-full h-screen bg-white z-[2001] opacity-0 invisible transition-all duration-400 overflow-y-auto" id="searchOverlay">
    ...
    <!-- Footer -->
    <div class="text-center px-8 py-12 border-t border-gray-200">
        <p class="text-sm text-gray-600 mb-2">Customer Service Available 7/7 on <a href="#" class="text-gray-900 underline">+31 207 219 441</a></p>
        <p class="text-sm text-gray-600"><a href="#" class="text-gray-900 underline">FAQs</a></p>
    </div>
</div>
    ...
    <div class="p-8">
        ...
        <div class="pb-8 border-b border-gray-200 mb-8">
            ...
            <div class="mb-4">
                ...
                <input type="email" class="w-full px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-gray-900 transition">
            </div>

            <div class="mb-4">
                <label class="block text-sm text-gray-900 mb-2">Password*</label>
                <input type="password" class="w-full px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-gray-900 transition">
            </div>
